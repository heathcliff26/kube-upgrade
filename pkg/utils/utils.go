...
const defaultNamespace = "kube-upgrade"
...
func GetNamespace() (string, error) {
	...
	if err != nil {
		if !errors.Is(err, os.ErrNotExist) {
			...
			slog.Info("There is no namespace file, falling back to default namespace", slog.String("defaultNamespace", defaultNamespace), slog.String("file", serviceAccountNamespaceFile))
