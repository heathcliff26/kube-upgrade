...
// +kubebuilder:webhook:path=/validate-kubeupgrade-heathcliff-eu-v1alpha1-kubeupgradeplan,mutating=false,failurePolicy=fail,groups=kubeupgrade.heathcliff.eu,resources=kubeupgradeplans;kubeupgradeplans/status,verbs=create;update,versions=v1alpha1,name=kubeupgrade.heathcliff.eu,admissionReviewVersions=v1,sideEffects=None
