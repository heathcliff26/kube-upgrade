...
type KubeUpgradePlanLister interface {
	...
	List(selector labels.Selector) (ret []*kubeupgradev1alpha2.KubeUpgradePlan, err error)
...
type kubeUpgradePlanLister struct {
	listers.ResourceIndexer[*kubeupgradev1alpha2.KubeUpgradePlan]
}
...
func NewKubeUpgradePlanLister(indexer cache.Indexer) KubeUpgradePlanLister {
	return &kubeUpgradePlanLister{listers.New[*kubeupgradev1alpha2.KubeUpgradePlan](indexer, kubeupgradev1alpha2.Resource("kubeupgradeplan"))}
}

// KubeUpgradePlans returns an object that can list and get KubeUpgradePlans.
func (s *kubeUpgradePlanLister) KubeUpgradePlans(namespace string) KubeUpgradePlanNamespaceLister {
	return kubeUpgradePlanNamespaceLister{listers.NewNamespaced[*kubeupgradev1alpha2.KubeUpgradePlan](s.ResourceIndexer, namespace)}
}
...
type KubeUpgradePlanNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kubeupgradev1alpha2.KubeUpgradePlan, error)
