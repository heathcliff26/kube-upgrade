...
type KubeUpgradePlanLister interface {
	...
	List(selector labels.Selector) (ret []*kubeupgradev1alpha3.KubeUpgradePlan, err error)
...
type kubeUpgradePlanLister struct {
	listers.ResourceIndexer[*kubeupgradev1alpha3.KubeUpgradePlan]
}
...
func NewKubeUpgradePlanLister(indexer cache.Indexer) KubeUpgradePlanLister {
	return &kubeUpgradePlanLister{listers.New[*kubeupgradev1alpha3.KubeUpgradePlan](indexer, kubeupgradev1alpha3.Resource("kubeupgradeplan"))}
}

// KubeUpgradePlans returns an object that can list and get KubeUpgradePlans.
func (s *kubeUpgradePlanLister) KubeUpgradePlans(namespace string) KubeUpgradePlanNamespaceLister {
	return kubeUpgradePlanNamespaceLister{listers.NewNamespaced[*kubeupgradev1alpha3.KubeUpgradePlan](s.ResourceIndexer, namespace)}
}
...
type KubeUpgradePlanNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*kubeupgradev1alpha3.KubeUpgradePlan, error)
