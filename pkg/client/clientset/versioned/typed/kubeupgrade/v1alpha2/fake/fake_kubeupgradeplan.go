...
var kubeupgradeplansResource = v1alpha2.SchemeGroupVersion.WithResource("kubeupgradeplans")

var kubeupgradeplansKind = v1alpha2.SchemeGroupVersion.WithKind("KubeUpgradePlan")

// Get takes name of the kubeUpgradePlan, and returns the corresponding kubeUpgradePlan object, and an error if there is any.
func (c *FakeKubeUpgradePlans) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.KubeUpgradePlan, err error) {
	emptyResult := &v1alpha2.KubeUpgradePlan{}
	obj, err := c.Fake.
	...
	return obj.(*v1alpha2.KubeUpgradePlan), err
}

// List takes label and field selectors, and returns the list of KubeUpgradePlans that match those selectors.
func (c *FakeKubeUpgradePlans) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.KubeUpgradePlanList, err error) {
	emptyResult := &v1alpha2.KubeUpgradePlanList{}
	obj, err := c.Fake.
	...
	list := &v1alpha2.KubeUpgradePlanList{ListMeta: obj.(*v1alpha2.KubeUpgradePlanList).ListMeta}
	for _, item := range obj.(*v1alpha2.KubeUpgradePlanList).Items {
...
func (c *FakeKubeUpgradePlans) Create(ctx context.Context, kubeUpgradePlan *v1alpha2.KubeUpgradePlan, opts v1.CreateOptions) (result *v1alpha2.KubeUpgradePlan, err error) {
	emptyResult := &v1alpha2.KubeUpgradePlan{}
	obj, err := c.Fake.
...
func (c *FakeKubeUpgradePlans) Update(ctx context.Context, kubeUpgradePlan *v1alpha2.KubeUpgradePlan, opts v1.UpdateOptions) (result *v1alpha2.KubeUpgradePlan, err error) {
	emptyResult := &v1alpha2.KubeUpgradePlan{}
	obj, err := c.Fake.
...
func (c *FakeKubeUpgradePlans) UpdateStatus(ctx context.Context, kubeUpgradePlan *v1alpha2.KubeUpgradePlan, opts v1.UpdateOptions) (result *v1alpha2.KubeUpgradePlan, err error) {
	emptyResult := &v1alpha2.KubeUpgradePlan{}
	obj, err := c.Fake.
...
func (c *FakeKubeUpgradePlans) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(kubeupgradeplansResource, c.ns, name, opts), &v1alpha2.KubeUpgradePlan{})
...
func (c *FakeKubeUpgradePlans) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha2.KubeUpgradePlanList{})
	return err
}

// Patch applies the patch and returns the patched kubeUpgradePlan.
func (c *FakeKubeUpgradePlans) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.KubeUpgradePlan, err error) {
	emptyResult := &v1alpha2.KubeUpgradePlan{}
	obj, err := c.Fake.
...
func (c *FakeKubeUpgradePlans) Apply(ctx context.Context, kubeUpgradePlan *kubeupgradev1alpha2.KubeUpgradePlanApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha2.KubeUpgradePlan, err error) {
...
func (c *FakeKubeUpgradePlans) ApplyStatus(ctx context.Context, kubeUpgradePlan *kubeupgradev1alpha2.KubeUpgradePlanApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha2.KubeUpgradePlan, err error) {
	if kubeUpgradePlan == nil {
		return nil, fmt.Errorf("kubeUpgradePlan provided to Apply must not be nil")
	}
	data, err := json.Marshal(kubeUpgradePlan)
